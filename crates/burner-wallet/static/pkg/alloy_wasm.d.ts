...
export function sign_eip7702_tx(private_key: string, tx_request_json: string): string;
...
export interface InitOutput {
  ...
  readonly sign_eip7702_tx: (a: number, b: number, c: number, d: number) => [number, number, number, number];
